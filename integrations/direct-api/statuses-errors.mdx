...
description: "Map LightSwap swap statuses, terminal states, and structured API errors to user-facing messages and support handling."
---
...
| `unsupported_memo`     | A memo was supplied for a network that does not support memos, or no route that can carry a memo is available for the pair. | Remove the memo and retry, or use a self-custody destination address or another pair. |
